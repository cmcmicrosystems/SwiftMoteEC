...
typedef struct
{
	...
	uint32_t  SeqStartAddr;         /**< Initialaztion sequence start address in SRAM of AD5941  */
	uint32_t  MaxSeqLen;            /**< Limit the maximum sequence.   */
	uint32_t  SeqStartAddrCal;      /**< Not used for Ramp.Calibration sequence start address in SRAM of AD5941 */
...
void AD5941_McuSetLow(void);
void AD5941_McuSetHigh(void);

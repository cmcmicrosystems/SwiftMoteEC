...
#define NUM_APP_GATT_SERVICES_CONF  (5)
...
// Sum of 2 registers should be 15, RTC_SYNCH_PREDIV determines precision of SubSeconds, but larger value causes higher energy consumption

...
/*! \mainpage AD5941 Library Introduction
 * 
 * ![AD5941 EVAL Board](https://www.analog.com/-/media/analog/en/evaluation-board-images/images/eval-AD5941elcztop-web.gif?h=500&thn=1&hash=1F38F7CC1002894616F74D316365C0A2631C432B "ADI logo") 
 * 
 * # Introduction
 *
 ...
 *
 * @ref AD5941_Library                                                      
 *  - @ref AD5941_Functions                                                 
 *  - @ref TypeDefinitions                                                    
 * @ref AD5941_Standard_Examples                                            
 * @ref AD5941_System_Examples	                                            
 * 
 * # How to Use It
 *  We provide examples that can directly run out of box.
 *  The files can generally be separated to three parts:
 *    - AD5941 Library files. AD5941.c and AD5941.h specifically. These two files are shared among all examples.
 *    - AD5941 System Examples. The system examples mean system level application like measuring impedance.
 ...
 *  ### Hardware
 *  - Use EVAL_AD5941 or EVAL_AD5941. The default MCU board we used is ADICUP3029. We also provide project for ST NUCLEO board.
 *  - Or use EVAL_ADuCM355
 *  ### Software
 *  - Pull all the source file from [GitHub](https://github.com/analogdevicesinc/AD5941-examples.git)
 ...
 *      - [AD5941 Data Sheet](https://www.analog.com/media/en/technical-documentation/data-sheets/AD5941.pdf)
 *      - [AD5941 Eval Board](https://www.analog.com/en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/EVAL-AD5941.html)
 *
 */
...
void AD5941_HFOSC32MHzCtrl(BoolFlag Mode32MHz)
{
  ...
  RdHPOSCCON = AD5941_ReadReg(REG_AFE_HPOSCCON); 
  if(Mode32MHz == bTRUE)
  {
